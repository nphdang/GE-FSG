## Run python gen_graph_dgk.py to convert graph format used by Deep Graph Kernel (http://www.mit.edu/~pinary/kdd/) to graph format used by GE-FSG (this algorithm)
